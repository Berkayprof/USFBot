                ...
                await toggleInteraction.followUp({
                    embeds: [successEmbed(
                        ...
                        `The **${updatedRole.name}** application is now **${wasEnabled ? 'disabled' : 'enabled'}**.\n\n${
                            wasEnabled 
                                ? 'The apply button for this application will no longer work.' 
                                : 'The apply button for this application works again. Use `/app-admin panel` to post a new panel if it is not on one yet.'
                        }`,
                    )],
                    flags: MessageFlags.Ephemeral,
                });
